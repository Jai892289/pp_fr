...
interface TogglePermissionDialogProps {
  open: boolean
        ...
        <DialogFooter className="flex-col space-y-3 pt-4">
          <div className="flex gap-3 w-full">
            <Button
              ...
              className="flex-1 h-11 rounded-sm border-2 hover:bg-gray-50 transition-all duration-200 "
            >
              Cancel
            </Button>
            <Button
